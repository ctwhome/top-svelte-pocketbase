	...
	<div class="w-full max-w-md">
		<div class="rounded-lg bg-white p-8 shadow-md">
				...
				<div class="flex items-start">
					...
					<div class="ml-3 flex-1">
						...
						<div class="mt-2 space-y-1 text-xs text-blue-700">
							...
							<p class="border-t border-blue-300 pt-2">
							...
							<a
								...
								target="_blank"
								class="mt-1 inline-block text-blue-600 underline hover:text-blue-800"
								>→ Admin Panel</a
							>
						</div>
					</div>
			...
			<p class="mt-4 text-center text-sm text-gray-600">
				...
				<a href="/register" class="font-medium text-blue-600 hover:text-blue-700"> Register </a>
			</p>
		</div>
	</div>
</div>
